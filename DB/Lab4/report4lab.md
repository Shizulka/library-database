...
### 4. ```COUNT``` & ```AVG``` (again) <!--я хз як цей пункт ще назвати, воно реально вже ж було-->
...
### 2. ```WHERE``` (again) <!--я взагалі не знаю як можна ці 3 пункти назвати, якшо в перших 2 категоріяг були функції які можна виділити то тут вони тупо повторюються-->
