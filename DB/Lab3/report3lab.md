...
##  Використані SQL-запити

| № | Тип запиту | SQL-запит |
| :---: | :--- | :--- |
| 1 | SELECT | `SELECT * FROM book` |
| 2 | INSERT | `Insert into book(title, language, year_published, pages ) Values ('test', 'Українська', 2025, 234)` |
| 3 | INSERT | `('Test2', 'Українська', 2024, 234)` |
| 4 | SELECT | `Select * from patron` |
| 5 | UPDATE | `Update patron Set email = '123@gmail.com' Where phone_number like '%066%'` |
